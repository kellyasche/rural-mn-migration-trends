...
My first idea is to just create bar charts that breakdown each component as a percentage of the total change. Each component would be positive, thus deaths and births each count equally as a unit of change.
